...
europe_quality_eval_scip_100s_30s = [
    ...
    "sparkle configure_solver --solver Solvers/SCIP --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 60 --objectives quality:max",
]
...
europe_quality_eval_timefold_100s_30s = [
    ...
    "sed -i '13s/.*/wallclock_time = 100/' ./Settings/sparkle_settings.ini",
    "sed -i '31s/.*/time = 04:00:00/' ./Settings/sparkle_settings.ini",
    "sparkle configure_solver --solver Solvers/Timefold --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 60 --objectives quality:max",
]
...
europe_quality_eval_gurobi_100s_30s = [
    ...
    "sed -i '13s/.*/wallclock_time = 100/' ./Settings/sparkle_settings.ini",
    "sed -i '31s/.*/time = 04:00:00/' ./Settings/sparkle_settings.ini",
    "sparkle configure_solver --solver Solvers/Gurobi --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 60 --objectives quality:max",
]
...
europe_quality_eval_scip_100s_60s = [
    ...
    "sed -i '13s/.*/wallclock_time = 100/' ./Settings/sparkle_settings.ini",
    "sed -i '31s/.*/time = 04:00:00/' ./Settings/sparkle_settings.ini",
    "sparkle configure_solver --solver Solvers/SCIP --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 90 --objectives quality:max",
]
...
europe_quality_eval_timefold_100s_60s = [
    ...
    "sed -i '13s/.*/wallclock_time = 100/' ./Settings/sparkle_settings.ini",
    "sed -i '31s/.*/time = 04:00:00/' ./Settings/sparkle_settings.ini",
    "sparkle configure_solver --solver Solvers/Timefold --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 90 --objectives quality:max",
]
...
europe_quality_eval_gurobi_100s_60s = [
    ...
    "sed -i '13s/.*/wallclock_time = 100/' ./Settings/sparkle_settings.ini",
    "sed -i '31s/.*/time = 04:00:00/' ./Settings/sparkle_settings.ini",
    "sparkle configure_solver --solver Solvers/Gurobi --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 90 --objectives quality:max",
]
...
europe_quality_eval_scip_100s_300s = [
    ...
    "sed -i '13s/.*/wallclock_time = 100/' ./Settings/sparkle_settings.ini",
    "sed -i '31s/.*/time = 04:00:00/' ./Settings/sparkle_settings.ini",
    "sparkle configure_solver --solver Solvers/SCIP --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 330 --objectives quality:max",
]
...
europe_quality_eval_scip_31622s_300s = [
    "sparkle initialise",
    "sparkle add_instances ../../SatQKDOptim/Instances/Dataset_Europe_Hard_Train",
    "sparkle add_instances ../../SatQKDOptim/Instances/Dataset_Europe_Hard_Test",
    "sparkle add_solver ../../SatQKDOptim/Solvers/SCIP",
    ...
    "rm -rf ./Settings && cp -r ../../Settings .",
    "sed -i '2s/.*/objectives = quality:max/' ./Settings/sparkle_settings.ini",
    "sed -i '13s/.*/wallclock_time = 31622/' ./Settings/sparkle_settings.ini",
    "sed -i '31s/.*/time = 10:00:00/' ./Settings/sparkle_settings.ini",
    "sparkle configure_solver --solver Solvers/SCIP --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 330 --objectives quality:max",
]
...
europe_quality_eval_timefold_100s_300s = [
    ...
    "sed -i '13s/.*/wallclock_time = 100/' ./Settings/sparkle_settings.ini",
    "sed -i '31s/.*/time = 04:00:00/' ./Settings/sparkle_settings.ini",
    "sparkle configure_solver --solver Solvers/Timefold --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 330 --objectives quality:max",
]
...
europe_quality_eval_timefold_31622s_300s = [
    "sparkle initialise",
    "sparkle add_instances ../../SatQKDOptim/Instances/Dataset_Europe_Hard_Train",
    "sparkle add_instances ../../SatQKDOptim/Instances/Dataset_Europe_Hard_Test",
    "sparkle add_solver ../../SatQKDOptim/Solvers/Timefold",
...
europe_quality_eval_gurobi_100s_300s = [
    ...
    "sed -i '13s/.*/wallclock_time = 100/' ./Settings/sparkle_settings.ini",
    "sed -i '31s/.*/time = 04:00:00/' ./Settings/sparkle_settings.ini",
    "sparkle configure_solver --solver Solvers/Gurobi --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 330 --objectives quality:max",
]
...
europe_quality_eval_gurobi_31622s_300s = [
    "sparkle initialise",
    "sparkle add_instances ../../SatQKDOptim/Instances/Dataset_Europe_Hard_Train",
    "sparkle add_instances ../../SatQKDOptim/Instances/Dataset_Europe_Hard_Test",
    "sparkle add_solver ../../SatQKDOptim/Solvers/Gurobi",
...
europe_quality_eval_scip_100s_600s = [
    ...
    "sed -i '13s/.*/wallclock_time = 100/' ./Settings/sparkle_settings.ini",
    "sed -i '31s/.*/time = 04:00:00/' ./Settings/sparkle_settings.ini",
    "sparkle configure_solver --solver Solvers/SCIP --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 630 --objectives quality:max",
]
...
europe_quality_eval_scip_31622s_600s = [
    "sparkle initialise",
    "sparkle add_instances ../../SatQKDOptim/Instances/Dataset_Europe_Hard_Train",
    "sparkle add_instances ../../SatQKDOptim/Instances/Dataset_Europe_Hard_Test",
    "sparkle add_solver ../../SatQKDOptim/Solvers/SCIP",
...
europe_quality_eval_timefold_100s_600s = [
    ...
    "sed -i '13s/.*/wallclock_time = 100/' ./Settings/sparkle_settings.ini",
    "sed -i '31s/.*/time = 04:00:00/' ./Settings/sparkle_settings.ini",
    "sparkle configure_solver --solver Solvers/Timefold --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 630 --objectives quality:max",
]
...
europe_quality_eval_timefold_31622s_600s = [
    "sparkle initialise",
    "sparkle add_instances ../../SatQKDOptim/Instances/Dataset_Europe_Hard_Train",
    "sparkle add_instances ../../SatQKDOptim/Instances/Dataset_Europe_Hard_Test",
    "sparkle add_solver ../../SatQKDOptim/Solvers/Timefold",
...
europe_quality_eval_gurobi_100s_600s = [
    ...
    "sed -i '13s/.*/wallclock_time = 100/' ./Settings/sparkle_settings.ini",
    "sed -i '31s/.*/time = 04:00:00/' ./Settings/sparkle_settings.ini",
    "sparkle configure_solver --solver Solvers/Gurobi --instance-set-train Instances/Dataset_Europe_Hard_Train --instance-set-test Instances/Dataset_Europe_Hard_Test --target-cutoff-time 630 --objectives quality:max",
]
...
europe_quality_eval_gurobi_31622s_600s = [
    "sparkle initialise",
    "sparkle add_instances ../../SatQKDOptim/Instances/Dataset_Europe_Hard_Train",
    "sparkle add_instances ../../SatQKDOptim/Instances/Dataset_Europe_Hard_Test",
    "sparkle add_solver ../../SatQKDOptim/Solvers/Gurobi",
...
evaluations_30s = [
  {
     ...
     "commands": europe_quality_eval_scip_100s_30s,
  }, 
  {
...
def run_evaluation(eval):
    ...
    os.chdir("convergence_eval_hard")
